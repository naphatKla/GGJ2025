...
{
    public class SkillHarmonyOfLightRuntime : BaseSkillRuntime<SkillHarmonyOfLightDataSo>
    {
        ...
        protected override void OnSkillStart()
        {
            ...
            for (int i = 0; i < skillData.LightAmount; i++)
            {
                ...
                skillInstance.DamageOnTouch.EnableDamage(owner.gameObject, owner.CharacterData.CharacterId, this, skillData.DamageHitPerSec, skillData.BaseDamagePerHit, skillData.DamageMultiplier);
