    ...
    public class SkillReflectionRuntime : BaseSkillRuntime<SkillReflectionDataSo>
    {
        ...
        protected override void OnSkillStart()
        {
            ...
            for (int i = 0; i < skillData.SkillObjectAmount; i++)
            {
                ...
                skillObject.DamageOnTouch.EnableDamage(owner.gameObject,owner.CharacterData.CharacterId ,this, skillData.DamageHitPerSec, skillData.BaseDamagePerHit, skillData.DamageMultiplier);
